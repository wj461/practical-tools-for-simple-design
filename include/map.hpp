...
private:
    ...
    std::shared_ptr<Block> NewBlock(glm::vec2 indexPos,
                                    glm::vec2 indexMap = {0, 0},
                                    BlockType type = BlockType::Map_Block,
                                    glm::int64 indexZ = MAP_Z,
                                    std::shared_ptr<Util::Image> img = nullptr);

    std::shared_ptr<WithTextButton> NewTextButton(glm::vec2 indexPos,
                                                  std::string text);
    // tool
    ...
    std::shared_ptr<Util::GameObject> test =
